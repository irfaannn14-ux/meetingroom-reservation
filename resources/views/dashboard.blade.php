    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="welcome-card mb-4" style="position: relative; min-height: 250px; overflow: hidden;"
                title="Made with ❤️ by Tim IT Diskominfo Kab. Probolinggo, Featuring Anak Magang 😁">
                <!-- Developer Image with shift effect -->
                <!-- <div class="developer-image"></div> -->
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center"
                    style="position: relative; z-index: 3; min-height: 210px;">
            ...
            <div class="calendar-container">
                <h4 class="mb-3" style="color:#010D26;font-weight:bold;font-family:'Montserrat',sans-serif;">Kalender
                    Pengajuan</h4>
                <div id='calendar'></div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h6 class="mb-0 card-title-text"
                                                style="color: #343a40; font-weight: bold; font-family: 'Montserrat', sans-serif;">
                                                Jam Operasional</h6>
                                            <p class="mb-0"
                                                style="color: #343a40; font-weight: bold; font-family: 'Montserrat', sans-serif;">
                                                08:00 - 17:00 WIB</p>

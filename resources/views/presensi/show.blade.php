                            ...
                            <tr>
                                ...
                                <td style="width: 250px;">
                                    @if ($presensi->ttd_path)
                                        @php
                                            // fallback: dukung 2 tipe nilai: base64 langsung ATAU path file di storage
                                            $src = Str::startsWith($presensi->ttd_path, 'data:image')
                                                ? $presensi->ttd_path
                                                : asset('storage/' . ltrim($presensi->ttd_path, '/'));
                                        @endphp
                                        <img src="{{ $src }}" alt="Tanda Tangan" style="width:200px; height:auto;">
                                    @else
